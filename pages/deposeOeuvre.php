				...
				<div class="bloc">
                    ...
                    <?php
						...
						if(isset($_GET['msg'])){
							if($_GET['msg'] == 1){
				    ?> 
                            <script>alert("!!! Attention !!!\nVeuillez remplir le document en cliquant sur le lien qui va apparaître pour télécharger le document.\nN'oubliez surtout pas de le renvoyer à l'adresse indiquée dans celui ci! \nSans ce document, votre candidature n'a plus aucun sens."); </script>
                    
                            <p class="messageReussite"> Votre oeuvre à bien été ajouté, elle sera soumise au jury ! Pensez 
                                à <a class="lienDeposeOeuvre" href="../vue/download/document.docx" download="document.docx"> télécharger le document.</a> </p> 
                    <?php
							}
						}
                        else{
